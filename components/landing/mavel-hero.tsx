    ...
    <section className="relative overflow-hidden bg-zinc-950 pt-32 pb-20 sm:pt-40 sm:pb-28">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:gap-10 lg:px-8">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          >
            Na <span className="font-medium text-zinc-200">MAVEL</span>, transformamos ideias em
            produtos exclusivos com impressão 3D de alta precisão. Criamos peças decorativas,
            utilitárias, colecionáveis e projetos personalizados com acabamento premium e atenção
            a cada detalhe.
          </motion.p>
          ...
          >
            ...
            >
              <Link href="#personalizados">Criar Projeto Personalizado</Link>
            </Button>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="relative aspect-4/5 overflow-hidden rounded-3xl border border-white/10 bg-zinc-900 shadow-2xl shadow-black/50">
            <Image
              src="https://picsum.photos/seed/mavel-printer-hero/900/1125"
